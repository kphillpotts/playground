...
namespace ImagesToVideo
{
    ...
    public class MainViewController : UIViewController
    {
		...
		public override void ViewDidLoad ()
		{
			...
			imageView = new UIImageView(new RectangleF(10, 200, 300, 300));
		    imageView.BackgroundColor = UIColor.Green;
			View.AddSubview(imageView);

			choosePhotoButton = UIButton.FromType (UIButtonType.Custom);
		    choosePhotoButton.BackgroundColor = UIColor.Red;
			choosePhotoButton.Frame = new RectangleF(10, 80, 100,120);
            ...
            var write = new ImageToVideo();
            write.WriteImagesToVideo(_images.ToArray(), filePath);
